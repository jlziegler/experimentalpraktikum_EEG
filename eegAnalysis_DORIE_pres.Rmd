...
## Beispielplot nach Epochierung
<small>eegUtils-Funktion: ```plot_timecourse```</small>
```{r, echo=T, eval=FALSE}
plot_timecourse(DORlist$DOR02.vhdr, "FCz", colour = "event_type")
```
...
## ICA Komponenten (Artifact Rejection)
...
# Statisik
## Zusammenfassen der Daten (Grand Average)
```{r, echo=T, eval=FALSE}
